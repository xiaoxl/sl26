...
The lasso penalty also shrinks the coefficients toward zero. However it has a major difference from ridge regression. 
...
axs[0].plot(ridge_r * np.cos(t), ridge_r * np.sin(t), linewidth=3)
axs[0].scatter(*mu)
axs[0].axhline(0)
axs[0].axvline(0)
axs[0].set_title("Ridge Constraint")

axs[1].contour(X, Y, Z, levels=levels)
diamond = np.array(
    [[lasso_t, 0], [0, lasso_t], [-lasso_t, 0], [0, -lasso_t], [lasso_t, 0]]
)
axs[1].plot(diamond[:, 0], diamond[:, 1], linewidth=3)
axs[1].scatter(*mu)
axs[1].axhline(0)
axs[1].axvline(0)
axs[1].set_title("Lasso Constraint")
